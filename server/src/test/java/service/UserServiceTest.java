...
public class UserServiceTest {
    ...
    @Test
    public void verifyUser_ValidCredentials_ReturnsTrue() throws DataAccessException {
    ...
    @Test
    public void verifyUser_InvalidUsername_ThrowsException() throws DataAccessException {
        //test for known user
        UserData testUser = new UserData("testuser", "password", "test@example.com");
        userService.makeUser(testUser);
    ...
    @Test
    public void verifyUser_InvalidPassword_ReturnsFalse() throws DataAccessException {
    ...
    @Test
    public void makeUser_ValidUser_ReturnsAuthData() throws DataAccessException {
    ...
    @Test
    public void makeUser_DuplicateUsername_ThrowsException() {
        //duplicate users
        UserData testUser = new UserData("testuser", "password", "test@example.com");
    ...
    @Test
    public void loginUser_ValidCredentials_ReturnsAuthData() throws DataAccessException {
        //register user first
        UserData testUser = new UserData("testuser", "password", "test@example.com");
        userService.makeUser(testUser);
    ...
    @Test
    public void loginUser_InvalidCredentials_ThrowsException() throws DataAccessException {
        UserData testUser = new UserData("testuser", "password", "test@example.com");
        userService.makeUser(testUser);
    ...
    @Test
    public void logoutUser_ValidAuthToken_Success() throws DataAccessException {
        UserData testUser = new UserData("testuser", "password", "test@example.com");
    ...
    @Test
    public void logoutUser_InvalidAuthToken_ThrowsException() {
